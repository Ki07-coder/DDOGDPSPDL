                    ...
                    <div class="player">
                        ...
                        <table class="table">
                            <tr v-for="score in entry.verified">
                                <td class="rank">
                                    <p v-if="i + 1 == 1" class="type-label-lg3">#{{ score.rank }}</p>
                                    <p v-else-if="i + 1 <= 150" class="type-label-lg">#{{ score.rank }}</p>
                                    <p v-else-if="i + 1 <= 150" class="type-label-lg1">#{{ score.rank }}</p>
